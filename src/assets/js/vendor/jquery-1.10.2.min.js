...
;(function (e, t) {
        ...
        if (h && !i) {
          if ((o = Z.exec(e)))
            if ((s = o[1])) {
              ...
              if (
                (s = o[3]) &&
                r.getElementsByclassNameName &&
                t.getElementsByclassNameName
              )
                return M.apply(n, t.getElementsByclassNameName(s)), n
            }
          if (r.qsa && (!g || !g.test(e))) {
            if (
              ((m = d = b),
        ...
        (p = at.setDocument = function (e) {
          ...
          return n !== f && 9 === n.nodeType && n.documentElement
            ? ((f = n),
              ...
              (r.getElementsByclassNameName = ut(function (e) {
                return (
                  (e.innerHTML =
                    "<div className='a'></div><div className='a i'></div>"),
                  (e.firstChild.classNameName = 'i'),
                  2 === e.getElementsByclassNameName('i').length
                )
              })),
              ...
              (o.find.className =
                r.getElementsByclassNameName &&
                function (e, n) {
                  return typeof n.getElementsByclassNameName !== j && h
                    ? n.getElementsByclassNameName(e)
                    : t
                }),
              (m = []),
              (g = []),
  ...
  ;(x.Callbacks = function (e) {
    ...
    (x.support = (function (t) {
      ...
      if (
        (d.setAttribute('classNameName', 't'),
        (d.innerHTML =
      ...
      ;(s = a.createElement('select')),
        ...
        (t.getSetAttribute = 't' !== d.classNameName),
  ...
  x.extend({
    ...
    acceptData: function (e) {
      ...
      return !t || (t !== !0 && e.getAttribute('classNameid') === t)
    },
  }),
    x.fn.extend({
      data: function (e, n) {
  ...
  x.fn.extend({
    ...
    addclassName: function (e) {
      ...
      if (x.isFunction(e))
        return this.each(function (t) {
          x(this).addclassName(e.call(this, t, this.classNameName))
        })
      if (l)
        for (t = (e || '').match(T) || []; s > a; a++)
          if (
            ...
            (r =
              1 === n.nodeType &&
              (n.classNameName
                ? (' ' + n.classNameName + ' ').replace(U, ' ')
                : ' ')))
          ) {
            o = 0
            while ((i = t[o++])) 0 > r.indexOf(' ' + i + ' ') && (r += i + ' ')
            n.classNameName = x.trim(r)
          }
      return this
    },
    removeclassName: function (e) {
      ...
      if (x.isFunction(e))
        return this.each(function (t) {
          x(this).removeclassName(e.call(this, t, this.classNameName))
        })
      if (l)
        for (t = (e || '').match(T) || []; s > a; a++)
          if (
    ...
    toggleclassName: function (e, t) {
      ...
      return 'boolean' == typeof t && 'string' === n
        ...
        ? this.each(function (n) {
            x(this).toggleclassName(e.call(this, n, this.classNameName, t), t)
          })
        : this.each(function () {
            if ('string' === n) {
              var t,
                ...
                a = e.match(T) || []
              while ((t = a[r++]))
                o.hasclassName(t) ? o.removeclassName(t) : o.addclassName(t)
            } else (n === i || 'boolean' === n) && (this.classNameName && x._data(this, '__classNameName__', this.classNameName), (this.classNameName = this.classNameName || e === !1 ? '' : x._data(this, '__classNameName__') || ''))
          })
    },
    hasclassName: function (e) {
      ...
      for (; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (' ' + this[n].classNameName + ' ').replace(U, ' ').indexOf(t) >= 0
        )
          return !0
      return !1
    },
